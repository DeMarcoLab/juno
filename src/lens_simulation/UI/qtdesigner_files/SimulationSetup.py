...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.label_options_title, 8, 0, 1, 1)
        self.label_pixel_size = QtWidgets.QLabel(self.frame_4)
        self.label_pixel_size.setObjectName("label_pixel_size")
        self.gridLayout_4.addWidget(self.label_pixel_size, 2, 0, 1, 1)
        self.doubleSpinBox_sim_wavelength = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.doubleSpinBox_sim_wavelength.setDecimals(6)
        self.doubleSpinBox_sim_wavelength.setMaximum(99999999.0)
        self.doubleSpinBox_sim_wavelength.setProperty("value", 488.0)
        self.doubleSpinBox_sim_wavelength.setObjectName("doubleSpinBox_sim_wavelength")
        self.gridLayout_4.addWidget(self.doubleSpinBox_sim_wavelength, 5, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_save_plot, 10, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_save_sim_config, 19, 0, 1, 2)
        self.doubleSpinBox_sim_width = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.doubleSpinBox_sim_width.setDecimals(6)
        self.doubleSpinBox_sim_width.setMaximum(99999999.0)
        self.doubleSpinBox_sim_width.setProperty("value", 1000.0)
        self.doubleSpinBox_sim_width.setObjectName("doubleSpinBox_sim_width")
        self.gridLayout_4.addWidget(self.doubleSpinBox_sim_width, 3, 1, 1, 1)
        self.checkBox_save_raw = QtWidgets.QCheckBox(self.frame_4)
        self.checkBox_save_raw.setObjectName("checkBox_save_raw")
        self.gridLayout_4.addWidget(self.checkBox_save_raw, 10, 1, 1, 1)
        self.label_sim_wavelength = QtWidgets.QLabel(self.frame_4)
        self.label_sim_wavelength.setObjectName("label_sim_wavelength")
        self.gridLayout_4.addWidget(self.label_sim_wavelength, 5, 0, 1, 1)
        self.scrollArea_stages = QtWidgets.QScrollArea(self.frame_4)
        self.scrollArea_stages.setMinimumSize(QtCore.QSize(0, 350))
        self.scrollArea_stages.setWidgetResizable(True)
        self.scrollArea_stages.setObjectName("scrollArea_stages")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 458, 348))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.scrollArea_stages.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout_4.addWidget(self.scrollArea_stages, 15, 0, 1, 2)
        self.doubleSpinBox_pixel_size = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.doubleSpinBox_pixel_size.setDecimals(6)
        self.doubleSpinBox_pixel_size.setMaximum(99999999.0)
        self.doubleSpinBox_pixel_size.setProperty("value", 1.0)
        self.doubleSpinBox_pixel_size.setObjectName("doubleSpinBox_pixel_size")
        self.gridLayout_4.addWidget(self.doubleSpinBox_pixel_size, 2, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_generate_simulation, 17, 0, 1, 2)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem, 16, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_sim_amplitude, 6, 0, 1, 1)
        self.doubleSpinBox_sim_height = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.doubleSpinBox_sim_height.setDecimals(6)
        self.doubleSpinBox_sim_height.setMaximum(99999999.0)
        self.doubleSpinBox_sim_height.setProperty("value", 1000.0)
        self.doubleSpinBox_sim_height.setObjectName("doubleSpinBox_sim_height")
        self.gridLayout_4.addWidget(self.doubleSpinBox_sim_height, 4, 1, 1, 1)
        self.label_sim_height = QtWidgets.QLabel(self.frame_4)
        self.label_sim_height.setObjectName("label_sim_height")
        self.gridLayout_4.addWidget(self.label_sim_height, 4, 0, 1, 1)
        self.doubleSpinBox_sim_amplitude = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.doubleSpinBox_sim_amplitude.setDecimals(1)
        self.doubleSpinBox_sim_amplitude.setMaximum(99999999.0)
        self.doubleSpinBox_sim_amplitude.setProperty("value", 10000.0)
        self.doubleSpinBox_sim_amplitude.setObjectName("doubleSpinBox_sim_amplitude")
        self.gridLayout_4.addWidget(self.doubleSpinBox_sim_amplitude, 6, 1, 1, 1)
        self.pushButton_sim_beam = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_sim_beam.setObjectName("pushButton_sim_beam")
        self.gridLayout_4.addWidget(self.pushButton_sim_beam, 7, 1, 1, 1)
        self.label_sim_num_stages = QtWidgets.QLabel(self.frame_4)
        self.label_sim_num_stages.setObjectName("label_sim_num_stages")
        self.gridLayout_4.addWidget(self.label_sim_num_stages, 13, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_stage_parameters_title, 12, 0, 1, 1)
        self.lineEdit_log_dir = QtWidgets.QLineEdit(self.frame_4)
        self.lineEdit_log_dir.setObjectName("lineEdit_log_dir")
        self.gridLayout_4.addWidget(self.lineEdit_log_dir, 9, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_setup_parameter_sweep, 18, 0, 1, 2)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 980, 800))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_pixel_size.setText(_translate("MainWindow", "Pixel Size (um)"))
        ...
        self.label_sim_width.setText(_translate("MainWindow", "Simulation Width (um)"))
        self.pushButton_save_sim_config.setText(_translate("MainWindow", "Save Simulation"))
        self.checkBox_save_raw.setText(_translate("MainWindow", "Save Raw Data"))
        self.label_sim_wavelength.setText(_translate("MainWindow", "Simulation Wavelength (nm)"))
        ...
        self.label_sim_height.setText(_translate("MainWindow", "Simulation Height (um)"))
