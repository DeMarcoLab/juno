...
class Ui_BeamCreator(object):
    def setupUi(self, BeamCreator):
        ...
        self.gridLayout_17.addWidget(self.label_OutputMedium, 3, 3, 1, 1)
        self.doubleSpinBox_OutputMedium = QtWidgets.QDoubleSpinBox(self.frame_General)
        self.doubleSpinBox_OutputMedium.setMaximum(99999.0)
        self.doubleSpinBox_OutputMedium.setObjectName("doubleSpinBox_OutputMedium")
        self.gridLayout_17.addWidget(self.doubleSpinBox_OutputMedium, 3, 5, 1, 1)
        ...
        self.comboBox_BeamSpread.addItem("")
        self.comboBox_BeamSpread.addItem("")
        self.gridLayout.addWidget(self.comboBox_BeamSpread, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_BeamSpread, 2, 0, 1, 1)
        self.comboBox_LensType = QtWidgets.QComboBox(self.frame_BeamSpread)
        self.comboBox_LensType.setObjectName("comboBox_LensType")
        self.comboBox_LensType.addItem("")
        self.comboBox_LensType.addItem("")
        self.gridLayout.addWidget(self.comboBox_LensType, 1, 0, 1, 1)
        self.label_LensType = QtWidgets.QLabel(self.frame_BeamSpread)
        self.label_LensType.setObjectName("label_LensType")
        self.gridLayout.addWidget(self.label_LensType, 0, 0, 1, 1)
