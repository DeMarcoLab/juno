...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame = QtWidgets.QFrame(self.frame_selection)
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.frame)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.pushButton_reset_data = QtWidgets.QPushButton(self.frame)
        self.pushButton_reset_data.setObjectName("pushButton_reset_data")
        self.gridLayout_4.addWidget(self.pushButton_reset_data, 7, 0, 1, 3)
        self.comboBox_column = QtWidgets.QComboBox(self.frame)
        self.comboBox_column.setObjectName("comboBox_column")
        self.gridLayout_4.addWidget(self.comboBox_column, 1, 1, 1, 2)
        self.lineEdit_value = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_value.setObjectName("lineEdit_value")
        self.gridLayout_4.addWidget(self.lineEdit_value, 3, 2, 1, 1)
        self.comboBox_modifier = QtWidgets.QComboBox(self.frame)
        self.comboBox_modifier.setObjectName("comboBox_modifier")
        self.gridLayout_4.addWidget(self.comboBox_modifier, 3, 1, 1, 1)
        self.pushButton_filter_data = QtWidgets.QPushButton(self.frame)
        self.pushButton_filter_data.setObjectName("pushButton_filter_data")
        self.gridLayout_4.addWidget(self.pushButton_filter_data, 6, 0, 1, 3)
        self.label_min_max = QtWidgets.QLabel(self.frame)
        self.label_min_max.setObjectName("label_min_max")
        self.gridLayout_4.addWidget(self.label_min_max, 4, 1, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_min_max.setText(_translate("MainWindow", "TextLabel"))
