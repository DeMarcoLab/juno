...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 233, 328))
        ...
        MainWindow.setTabOrder(self.pushButton_setup_parameter_sweep, self.pushButton_save_sim_config)
