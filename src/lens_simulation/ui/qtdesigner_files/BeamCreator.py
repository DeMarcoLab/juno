...
class Ui_BeamCreator(object):
    def setupUi(self, BeamCreator):
        ...
        self.frame_Main.setMaximumSize(QtCore.QSize(2000, 2000))
        ...
        self.doubleSpinBox_Height.setMinimum(0.001)
        self.doubleSpinBox_Height.setMaximum(999999.0)
        ...
        self.doubleSpinBox_Width.setMinimum(0.001)
        self.doubleSpinBox_Width.setMaximum(999999.0)
        ...
        self.doubleSpinBox_DistanceMethod = QtWidgets.QDoubleSpinBox(self.frame_General)
        self.doubleSpinBox_DistanceMethod.setDecimals(0)
        self.doubleSpinBox_DistanceMethod.setMinimum(1.0)
        self.doubleSpinBox_DistanceMethod.setMaximum(99999.0)
        self.doubleSpinBox_DistanceMethod.setObjectName("doubleSpinBox_DistanceMethod")
        self.gridLayout_10.addWidget(self.doubleSpinBox_DistanceMethod, 7, 1, 1, 1)
        self.comboBox_DistanceMethod = QtWidgets.QComboBox(self.frame_General)
        self.comboBox_DistanceMethod.setObjectName("comboBox_DistanceMethod")
        self.comboBox_DistanceMethod.addItem("")
        self.comboBox_DistanceMethod.addItem("")
        self.gridLayout_10.addWidget(self.comboBox_DistanceMethod, 7, 0, 1, 1)
        ...
        self.doubleSpinBox_SimWidth.setDecimals(3)
        self.doubleSpinBox_SimWidth.setMinimum(0.001)
        self.doubleSpinBox_SimWidth.setMaximum(999999.0)
        ...
        self.doubleSpinBox_SimHeight.setDecimals(3)
        self.doubleSpinBox_SimHeight.setMinimum(0.001)
        self.doubleSpinBox_SimHeight.setMaximum(999999.0)
        ...
        self.doubleSpinBox_BeamTiltY.setMinimum(-89.99)
        self.doubleSpinBox_BeamTiltY.setMaximum(89.99)
        ...
        self.gridLayout_2.addWidget(self.frame_Config, 0, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.frame_Profile, 1, 0, 1, 1)
        self.frame_FinalProfile = QtWidgets.QFrame(self.frame_Display)
        self.frame_FinalProfile.setMinimumSize(QtCore.QSize(550, 550))
        self.frame_FinalProfile.setMaximumSize(QtCore.QSize(550, 550))
        self.frame_FinalProfile.setAutoFillBackground(True)
        self.frame_FinalProfile.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_FinalProfile.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_FinalProfile.setObjectName("frame_FinalProfile")
        self.gridLayout_16 = QtWidgets.QGridLayout(self.frame_FinalProfile)
        self.gridLayout_16.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.label_FinalProfile = QtWidgets.QLabel(self.frame_FinalProfile)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_FinalProfile.sizePolicy().hasHeightForWidth())
        self.label_FinalProfile.setSizePolicy(sizePolicy)
        self.label_FinalProfile.setMinimumSize(QtCore.QSize(550, 550))
        self.label_FinalProfile.setMaximumSize(QtCore.QSize(550, 550))
        self.label_FinalProfile.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.label_FinalProfile.setText("")
        self.label_FinalProfile.setObjectName("label_FinalProfile")
        self.gridLayout_16.addWidget(self.label_FinalProfile, 0, 0, 1, 1)
        self.gridLayout_14.addWidget(self.frame_FinalProfile, 1, 2, 1, 1)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(350, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem3, 2, 1, 1, 1)
        self.pushButton_CalculateFinalProfile = QtWidgets.QPushButton(self.frame_Buttons)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_CalculateFinalProfile.sizePolicy().hasHeightForWidth())
        self.pushButton_CalculateFinalProfile.setSizePolicy(sizePolicy)
        self.pushButton_CalculateFinalProfile.setMinimumSize(QtCore.QSize(60, 40))
        self.pushButton_CalculateFinalProfile.setMaximumSize(QtCore.QSize(1000, 50))
        self.pushButton_CalculateFinalProfile.setObjectName("pushButton_CalculateFinalProfile")
        self.gridLayout_7.addWidget(self.pushButton_CalculateFinalProfile, 6, 0, 1, 1)
        self.gridLayout_14.addWidget(self.frame_Buttons, 2, 0, 1, 1)
        self.frame_Convergence = QtWidgets.QFrame(self.frame_Display)
        self.frame_Convergence.setMinimumSize(QtCore.QSize(361, 45))
        self.frame_Convergence.setMaximumSize(QtCore.QSize(16777215, 45))
        self.frame_Convergence.setAutoFillBackground(True)
        self.frame_Convergence.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_Convergence.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_Convergence.setObjectName("frame_Convergence")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.frame_Convergence)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem4)
        self.label_TitleMask = QtWidgets.QLabel(self.frame_Convergence)
        ...
        self.horizontalLayout_2.addWidget(self.label_TitleMask)
        self.label = QtWidgets.QLabel(self.frame_Convergence)
        self.label.setMaximumSize(QtCore.QSize(30, 16777215))
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.comboBox_ConvergenceDisplay = QtWidgets.QComboBox(self.frame_Convergence)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_ConvergenceDisplay.sizePolicy().hasHeightForWidth())
        self.comboBox_ConvergenceDisplay.setSizePolicy(sizePolicy)
        self.comboBox_ConvergenceDisplay.setMaximumSize(QtCore.QSize(50, 16777215))
        self.comboBox_ConvergenceDisplay.setObjectName("comboBox_ConvergenceDisplay")
        self.comboBox_ConvergenceDisplay.addItem("")
        self.comboBox_ConvergenceDisplay.addItem("")
        self.horizontalLayout_2.addWidget(self.comboBox_ConvergenceDisplay)
        self.gridLayout_14.addWidget(self.frame_Convergence, 0, 1, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.frame_ProfileMask, 1, 1, 1, 1)
        self.frame_5 = QtWidgets.QFrame(self.frame_Display)
        self.frame_5.setMinimumSize(QtCore.QSize(361, 45))
        ...
        self.label_TitleMask_8 = QtWidgets.QLabel(self.frame_5)
        self.label_TitleMask_8.setStyleSheet("font: 14pt \"MS Shell Dlg 2\";")
        self.label_TitleMask_8.setAlignment(QtCore.Qt.AlignCenter)
        self.label_TitleMask_8.setObjectName("label_TitleMask_8")
        self.horizontalLayout_9.addWidget(self.label_TitleMask_8)
        self.gridLayout_14.addWidget(self.frame_5, 0, 2, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1905, 21))
        ...
        BeamCreator.setTabOrder(self.doubleSpinBox_ShiftY, self.doubleSpinBox_OutputMedium)
    ...
    def retranslateUi(self, BeamCreator):
        ...
        self.comboBox_DistanceMode.setItemText(1, _translate("BeamCreator", "Final Beam Diameter"))
        ...
        self.pushButton_CalculateFinalProfile.setText(_translate("BeamCreator", "Calculate Final Profile"))
        self.label_TitleMask.setText(_translate("BeamCreator", "Convergence/Divergence"))
        self.label.setText(_translate("BeamCreator", "Axis: "))
        self.comboBox_ConvergenceDisplay.setItemText(0, _translate("BeamCreator", "X"))
        self.comboBox_ConvergenceDisplay.setItemText(1, _translate("BeamCreator", "Y"))
        self.label_TitleProfile.setText(_translate("BeamCreator", "Beam Profile + Tilt"))
        self.label_TitleMask_8.setText(_translate("BeamCreator", "Final Profile"))
