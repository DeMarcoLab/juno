...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.pushButton_reset_data, 6, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.pushButton_filter_data, 5, 0, 1, 3)
        ...
        self.scroll_area_filter.setMinimumSize(QtCore.QSize(0, 200))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 476, 198))
        ...
        self.gridLayout_2.addWidget(self.comboBox_napari_sim, 10, 0, 1, 1)
        self.pushButton_open_napari = QtWidgets.QPushButton(self.frame_selection)
        self.pushButton_open_napari.setObjectName("pushButton_open_napari")
        self.gridLayout_2.addWidget(self.pushButton_open_napari, 11, 0, 1, 1)
        self.tableLayout = QtWidgets.QVBoxLayout()
        self.tableLayout.setObjectName("tableLayout")
        self.gridLayout_2.addLayout(self.tableLayout, 8, 0, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.gridLayout_3, 9, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_open_napari.setText(_translate("MainWindow", "View All Simulations"))
        ...
        self.label_vis_scale.setText(_translate("MainWindow", "Visualisation Scale"))
